...
export default function  StartApp({ navigation }) {
    return (
      <View style={styles.container}>
        <Text style={{color:'black', fontWeight:'bold', fontSize:20, textAlign:'center', marginTop:30}}>A premium online store for sport and their stylish choice</Text>
        <Image style={{ marginTop: 10, height: 300, width: 300, marginLeft: 25, marginBottom: 20 , borderRadius:10}} source={require('./images/Screen011.jpg')} />
          ...
          <Button title='Get Stated'  color={"red"}  onPress={()=>{navigation.navigate('Screen_02')}}></Button>
          </View>
